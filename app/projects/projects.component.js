System.register(['angular2/core', 'angular2/router', './list/chatserver/chatserver.component', './list/java-poker/java-poker.component', './list/joypad/joypad.component', './list/mappy-stars/mappy-stars.component', './list/reddit-clone/reddit-clone.component', './list/space-invaders/space-invaders.component', './list/torcom/torcom.component'], function(exports_1, context_1) {
    ...
    var core_1, router_1, chatserver_component_1, java_poker_component_1, joypad_component_1, mappy_stars_component_1, reddit_clone_component_1, space_invaders_component_1, torcom_component_1;
        ...
        execute: function() {
            ProjectsComponent = (function () {
                ...
                ProjectsComponent = __decorate([
                    core_1.Component({
                        selector: 'projects',
                        directives: [router_1.ROUTER_DIRECTIVES, chatserver_component_1.ChatserverComponent, java_poker_component_1.JavapokerComponent, joypad_component_1.JoypadComponent, mappy_stars_component_1.MappystarsComponent, reddit_clone_component_1.RedditComponent, space_invaders_component_1.SpaceComponent, torcom_component_1.TorcomComponent],
